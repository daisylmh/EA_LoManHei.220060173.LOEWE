...
import 'my_selection_model.dart';
export 'my_selection_model.dart';
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      FFLocalizations.of(context).getText(
                        '3dy3lmgh' /* Shipping to United Kingdom-Eng... */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Readex Pro',
                            fontSize: 13.0,
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      FFLocalizations.of(context).getText(
                        'hzfurim0' /* You have no items in your bask... */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Readex Pro',
                            fontSize: 13.0,
                ...
                child: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'mgdz3o9h' /* Freen shipping & returns */,
                        ),
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Readex Pro',
                              fontWeight: FontWeight.bold,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                '8cym3hun' /* You have 0 items in your selec... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'yof2wjhp' /* Discover our most iconic lines */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'ifru71yb' /* Find your own ideal iconic bag */,
                              ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '0d1wehqc' /* Become part of the LOEWE commu... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                ...
                                children: [
                                  TextSpan(
                                    text: FFLocalizations.of(context).getText(
                                      'p3i3i4dk' /* Receive first access to the ve... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'yonca7qm' /* Privacy and cookies policy */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
